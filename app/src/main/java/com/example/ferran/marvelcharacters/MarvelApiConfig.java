 ...
 * This class contain the URLs to search in the Marvel Api
 */
...
public class MarvelApiConfig {
    ...
    public static final String TOTAL_RESOURCES = "limit=100";
    public static final String TOTAL_EVENT_RESOURCES = "limit=10";
