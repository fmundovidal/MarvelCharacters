...
public class MyListAdapterRecycler extends RecyclerView.Adapter<MyListAdapterRecycler.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            bodyTxtView.setMovementMethod(new ScrollingMovementMethod() {
            });
        }
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if(!this.mitemList.get(position).getmBody().equals("")&&!this.mitemList.get(position).getmBody().equals(" "))
            holder.bodyTxtView.setText(this.mitemList.get(position).getmBody());
        else
            holder.bodyTxtView.setText("No description");
    ...
    public void onBindViewHolder(ViewHolder holder, final int position, List<Object> payloads) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mIsActivityMain) {
                    Toast.makeText(mContext, "Accessing to " + String.valueOf(mHero.getCharacterArray().get(position)), Toast.LENGTH_LONG).show();
